...
from .views import ProjectCreateView, ProjectListView, ProjectUpdateView, ProjectDetailView, ProjectDeleteView, TaskCreateView, TaskDetailView, TaskUpdateView, TaskDeleteView, MyTasksView, ProjectHomeView
